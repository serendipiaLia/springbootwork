...
public class ApiController {
	...
	public @ResponseBody String getData() {
		try {
			// 지진 해일 대피소 데이터 테스트
			String url ="https://apis.data.go.kr/1741000/TsunamiShelter3/getTsunamiShelter1List?serviceKey=3e6KfjqGd%2BSHh5QtxpCL6hAh8NyMv%2Bzbbz4btxYu3dmUvLkrW6msC23slFSCHRrGmyHzajC8cTa1OcvCICFebQ%3D%3D&pageNo=1&numOfRows=10&type=json";
			...
			return responseText; // json형태로 반환
		} catch (IOException e) {
			e.printStackTrace();
		}
		return null;
