...
public class ReplyController {
	...
	public @ResponseBody String insertReply(@PathVariable Integer boardId, @RequestBody Reply reply,
											@AuthenticationPrincipal SecurityUser principal) { // 로그인 된 사람 가져오기
		
		reply.setMember(principal.getMember()); // 로그인 한 회원
